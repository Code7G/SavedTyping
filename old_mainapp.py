...
# This app is an older version of the newest app (mainapp.py)
# This map creates multiple files for every save while the newer one creates only one with the same amount of data
# Use this app if you prefer to however it will take unnececry procesing
